                ...
                GRID_DATA_ITEMS.map( (gridDataitem) => {
                  ...
                  return (
                    <Link key={id} href={attributes.href}>
                      <div className={`${attributes.background} w-36 h-36 lg:w-52 lg:h-52 flex items-end border-black border-[2px] `}>
                        <div className={
                          `font-ranga bg-slate-200/75 w-full text-center mb-2
                           text-sm lg:text-2xl h-[18px] lg:h-[30px] hover:text-white
